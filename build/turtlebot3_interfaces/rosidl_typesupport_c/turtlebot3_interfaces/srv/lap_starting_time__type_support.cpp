...
static const _LapStartingTime_Request_type_support_symbol_names_t _LapStartingTime_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot3_interfaces, srv, LapStartingTime_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot3_interfaces, srv, LapStartingTime_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot3_interfaces, srv, LapStartingTime_Request)() {
  return &::turtlebot3_interfaces::srv::rosidl_typesupport_c::LapStartingTime_Request_message_type_support_handle;
}
...
static const _LapStartingTime_Response_type_support_symbol_names_t _LapStartingTime_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot3_interfaces, srv, LapStartingTime_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot3_interfaces, srv, LapStartingTime_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot3_interfaces, srv, LapStartingTime_Response)() {
  return &::turtlebot3_interfaces::srv::rosidl_typesupport_c::LapStartingTime_Response_message_type_support_handle;
}
...
static const _LapStartingTime_type_support_symbol_names_t _LapStartingTime_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot3_interfaces, srv, LapStartingTime)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot3_interfaces, srv, LapStartingTime)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot3_interfaces, srv, LapStartingTime)() {
  return &::turtlebot3_interfaces::srv::rosidl_typesupport_c::LapStartingTime_service_type_support_handle;
}
